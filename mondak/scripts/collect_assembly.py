...
CMT_CD={"01":"원안가결","02":"수정가결","03":"대안반영폐기","04":"폐기","05":"철회","06":"철회",
 "13":"수정가결","19":"부결","20":"대안반영폐기"}
def stage_of(res):
    # 처리결과가 명시된 것만 '처리완료(종료)', 나머지는 '심사 중'
    # 본회의 통과 집계는 발의 API만으로 부정확 → 통과 분류 제외
    if not res: return "계류"
    if any(k in res for k in ("가결","공포","통과","수용","폐기","부결","철회","임기만료","각하","반영")): return "종료"
    return "계류"
