...
**뉴스(보도)의 경우**
1단계를 통과한 기사, 즉 **알리는 글이 아니라 제주 관광의 실태·평가를 다룬 기사**만 판정합니다.
· 긍정: 제주 관광이 실제로 나아졌음을 보여주는 보도.
  관광객·매출 증가, 만족도·재방문 의향 상승, 개선 성과가 수치로 확인됨,
  제주 관광에 대한 호평·칭찬, 달라진 점을 긍정적으로 조명
· 부정: 제주 관광·여행의 문제를 지적하는 보도.
  바가지·불친절·안전 문제·환경 훼손·정책 비판·관광객 감소·이미지 훼손,
  관광객이 겪은 피해, 업계의 어려움
· 중립: 위 어느 쪽도 아닌 사실 전달(통계 발표, 사건 경과 보도 등).
  단, 홍보가 목적인 기사는 중립이 아니라 1단계에서 제외해야 합니다.
...
[{"i":0,"rel":true,"sent":"부정","cat":"치안·안전","why":"실종사건 불안"},
 {"i":1,"rel":false,"sent":"중립","cat":"","why":"렌터카 업체 광고"}]
why는 12자 이내로 짧게 쓰세요."""
